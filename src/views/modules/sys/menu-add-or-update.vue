        ...
        <el-row>
          ...
          <el-col :span="2" class="icon-list__tips">
            <el-tooltip placement="top" effect="light">
              <div slot="content">全站推荐使用SVG Sprite, 详细请参考:<a href="//github.com/daxiongYang/amarsoft-mall-vue/blob/master/src/icons/index.js" target="_blank">icons/index.js</a>描述</div>
